...
public partial class Leader_学生情况 : System.Web.UI.Page
{
    ...
    protected void btnOK_Click(object sender, EventArgs e)//查询
    {
        ...
        DataTable dt2 = GetStudentDt(ddlWeek.SelectedItem.Text.ToString(), ddlDepartment.SelectedItem.Text.ToString());
        if (dt2.Rows.Count == 0)
        {
            lblHomework.Visible = true;
        }
    ...
    {
        ExportToSpreadsheet(GetHomeworkDt(ddlWeek.SelectedItem.Text.ToString(), ddlDepartment.SelectedItem.Text.ToString()),  ddlDepartment.SelectedItem.Text.ToString() + "学生作业信息");
    }
}