<%@ Page Title="" Language="C#" MasterPageFile="~/Leader/LeaderMasterPage.master" AutoEventWireup="true" CodeFile="学生情况.aspx.cs" Inherits="Leader_学生情况" %>
    ...
    <div id="daochhu-top">
        ...
        <table class="xuesheng-table xuesheng-table1">
            <tr>
                ...
                <td>
                     <asp:Label ID="lblDepartment" runat="server" Text="按系部查询" ForeColor="White"></asp:Label>
