...
public partial class Leader_LeaderMasterPage : System.Web.UI.MasterPage
{
    ...
    protected void topbtn1_Click1(object sender, EventArgs e)//修改密码
    {
        Response.Redirect("~\\Leader\\修改密码.aspx");     
    }
    protected void topbtn2_Click1(object sender, EventArgs e)//退出
    {
        Session["Role"] = null;
        Session["UserID"] = null;
    ...
    protected void ImageButton1_Click1(object sender, ImageClickEventArgs e)//头像
    {
        Response.Redirect("~\\Leader\\个人资料.aspx"); 
    }
}
