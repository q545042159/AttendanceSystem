...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <ul>
        <li class="kaoqin-show-li"><asp:Label ID="Label1" CssClass="lbl" runat="server" Text="Label"></asp:Label></li><!--没用  你们懂得！！！-->
        <li class="kaoqin-show-li"><asp:Label ID="lblAttendanceMessage" CssClass="lbl"  runat="server" Text="旷课名单："></asp:Label></li>
        <li class="kaoqin-show-li"><asp:Label ID="lblLateMessage" CssClass="lbl"  runat="server" Text="迟到名单："></asp:Label></li>
        <li class="kaoqin-show-li"><asp:Label ID="lblEarlyMessage" CssClass="lbl"  runat="server" Text="早退名单："></asp:Label></li>
        <li class="kaoqin-show-li"><asp:Label ID="lblLeaveMessage" CssClass="lbl"  runat="server" Text="请假名单："></asp:Label></li>
